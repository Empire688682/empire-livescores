                ...
                match && match.country ?
                    <>
                        <div className={style.header}>
                            <div>
                                <Image src={match.teams.home.logo} alt='logo' width={50} height={50} className={style.teamLogo} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" />
                            ...
                            <div>
                                <Image src={match.teams.away.logo} alt='logo' width={50} height={50} className={style.teamLogo} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" />
