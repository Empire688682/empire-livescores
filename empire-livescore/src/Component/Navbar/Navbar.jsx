    ...
    <div className={style.navbar}>
      ...
      <div className={style.right_col}>
        <ul>
          <Link
            href="/"
            onClick={() => setMenu("scores")}
            className={menu === "scores" ? style.active : style.menu}
          >
            {" "}
          ...
          <Link
            ...
            className={menu === "news" ? style.active : style.menu}
          >
            {" "}
            <FaRegNewspaper className={style.menu_icon} /> News{" "}
          </Link>
        </ul>
      </div>
