  ...
  return (
    <div className={style.single_news}>
      ...
      <div className={style.content}>
        ...
        <p>
          Both sides have won one, lost one in the revamped competition so far
          but they could end up having to settle for a point from the big
          midweek showdown.
        </p>
        <p>
          This mouth-watering Euro clash sees new Barca boss Hansi Flick go up
          against his old club, while Barca striker Robert Lewandowski faces his
          former side in a matchday three game laden with sub-plots.
        </p>
      </div>
